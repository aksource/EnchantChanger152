...
public class GuiToolHolder extends GuiContainer
{
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
	{
		...
		if(this.Num == 3)
			this.mc.renderEngine.bindTexture(MultiToolHolders.GuiToolHolder3);
		else if(this.Num == 5)
			this.mc.renderEngine.bindTexture(MultiToolHolders.GuiToolHolder5);
		else if(this.Num == 7)
			this.mc.renderEngine.bindTexture(MultiToolHolders.GuiToolHolder7);
		else if(this.Num == 9)
			this.mc.renderEngine.bindTexture(MultiToolHolders.GuiToolHolder9);
		int x = (width - xSize) / 2;

...
public class HyperDimensionalBag
{
	...
	public static String GuiBagTex ="/mods/ak/HyperDimensionalBag/textures/gui/GuiBag.png";
	public static String TextureDomain = "ak/HyperDimensionalBag:";
	...
	public void load(FMLInitializationEvent event)
	{
		...
		HDBag = new ItemHDBag(bagID - 256).setUnlocalizedName(this.TextureDomain + "Bag").setCreativeTab(CreativeTabs.tabTools);
		for(int i = 0;i<15;i++)

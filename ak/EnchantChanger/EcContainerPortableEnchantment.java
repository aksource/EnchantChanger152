...
public class EcContainerPortableEnchantment extends Container
{
	 ...
	 public void detectAndSendChanges()
	{
	 ...
	 public boolean enchantItem(EntityPlayer player, int par2)
	 {
		 ...
		 if (this.enchantLevels[par2] > 0 && var3 != null && (player.experienceLevel >= this.enchantLevels[par2] || player.capabilities.isCreativeMode))
		 {
			 if (!player.worldObj.isRemote)
			 {
				 ...
				 if (var4 != null)
				 {
					 player.addExperienceLevel(-this.enchantLevels[par2]);

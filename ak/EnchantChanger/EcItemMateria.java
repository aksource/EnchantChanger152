...
public class EcItemMateria extends Item
{
	...
	public static void Teleport(ItemStack itemstack, World world, EntityPlayer entityplayer)
	{
		...
		{
			Vec3 tP = setTeleportPoint(world,entityplayer);
			if(tP !=null)
			{
				entityplayer.setPositionAndUpdate(tP.xCoord, tP.yCoord, tP.zCoord);
				if(!entityplayer.capabilities.isCreativeMode)
				{
	...
	public static void Despell(EntityPlayer player,Entity entity)
	{
		if(entity instanceof EntityLiving)
		{
	...
	public static void Haste(EntityPlayer player,EntityLiving entityliving)
	{

...
public class ClientProxy extends CommonProxy
{
	...
	{
		RenderingRegistry.registerEntityRenderingHandler(EcEntityExExpBottle.class, new EcRenderItemThrowable(0.5F, EnchantChanger.EcExpBottlePNG));
		RenderingRegistry.registerEntityRenderingHandler(EcEntityMeteo.class, new EcRenderItemThrowable(EnchantChanger.MeteoSize, EnchantChanger.EcMeteoPNG));

...
public class RenderHNPC extends RenderLiving
{
	 ...
	 */
	protected int setArmorModel(EntityHNPCs entity, int par2, float par3)
	{
		ItemStack itemstack = entity.getCurrentArmor(3 - par2);
...
//		}
		...
		if (itemstack != null)
		{
			...
			if (item instanceof ItemArmor)
			{
				...
				this.loadTexture(ForgeHooksClient.getArmorTexture(entity, itemstack, "/armor/" + armorFilenamePrefix[itemarmor.renderIndex] + "_" + (par2 == 2 ? 2 : 1) + ".png", par2, 1));
				...
				modelbiped = ForgeHooksClient.getArmorModel(entity, itemstack, par2, modelbiped);
	...
	public void renderHNPC(EntityHNPCs hnpc, double par2, double par4, double par6, float par8, float par9)
	{
//		if (MinecraftForge.EVENT_BUS.post(new RenderPlayerEvent.Pre(par1EntityPlayer, this))) return;
		float f2 = 1.0F;
		GL11.glColor3f(f2, f2, f2);
		ItemStack itemstack = hnpc.getCurrentItemOrArmor(0);
...
//		this.modelArmorChestplate.isSneak = this.modelArmor.isSneak = this.modelBipedMain.isSneak = par1EntityPlayer.isSneaking();
		double d3 = par4 - (double)hnpc.yOffset;
//
...
//		}
		...
		super.doRenderLiving(hnpc, par2, d3, par6, par8, par9);
...
//		MinecraftForge.EVENT_BUS.post(new RenderPlayerEvent.Post(par1EntityPlayer, this));
	 ...
	 */
	protected void renderSpecials(EntityHNPCs hnpc, float par2)
	{
...
//		}
		...
		float f1 = 1.0F;
		GL11.glColor3f(f1, f1, f1);
		super.renderEquippedItems(hnpc, par2);
		super.renderArrowsStuckInEntity(hnpc, par2);
		ItemStack itemstack = hnpc.getCurrentArmor(3);
		...
		if (itemstack != null/* && event.renderHelmet*/)
		{
			...
			if (itemstack != null && itemstack.getItem() instanceof ItemBlock)
			{
				...
				this.renderManager.itemRenderer.renderItem(hnpc, itemstack, 0);
			}
...
//		if (hnpc.username.equals("deadmau5") && this.loadDownloadableImageTexture(hnpc.skinUrl, (String)null))
//		{
//			for (int i = 0; i < 2; ++i)
//			{
//				float f5 = hnpc.prevRotationYaw + (hnpc.rotationYaw - hnpc.prevRotationYaw) * par2 - (hnpc.prevRenderYawOffset + (hnpc.renderYawOffset - hnpc.prevRenderYawOffset) * par2);
//				f3 = hnpc.prevRotationPitch + (hnpc.rotationPitch - hnpc.prevRotationPitch) * par2;
//				GL11.glPushMatrix();
...
//		}
		...
		ItemStack itemstack1 = hnpc.getHeldItem();
...
//				if (hnpc.getItemInUseCount() > 0 && enumaction == EnumAction.block)
//				{
...
//				}
			...
			if (itemstack1.getItem().requiresMultipleRenderPasses())
			{
				for (j = 0; j < itemstack1.getItem().getRenderPasses(itemstack1.getItemDamage()); ++j)
				{
					...
					this.renderManager.itemRenderer.renderItem(hnpc, itemstack1, j);
				}
			}
			else
			{
				...
				this.renderManager.itemRenderer.renderItem(hnpc, itemstack1, 0);
			}
...
//		MinecraftForge.EVENT_BUS.post(new RenderPlayerEvent.Specials.Post(par1EntityPlayer, this, par2));
	...
	protected void renderHNPCScale(EntityHNPCs hnpc, float par2)
	{
		float f1 = 0.9375F;
...
//	}
	...
	{
		this.renderHNPCScale((EntityHNPCs) par1EntityLiving, par2);
	}

//	protected void func_82408_c(EntityLiving par1EntityLiving, int par2, float par3)
//	{
//		this.func_82439_b((EntityHNPCs)par1EntityLiving, par2, par3);
//	}
	...
	{
		return this.setArmorModel((EntityHNPCs)par1EntityLiving, par2, par3);
	}

	protected void renderEquippedItems(EntityLiving par1EntityLiving, float par2)
	{
		this.renderSpecials((EntityHNPCs) par1EntityLiving, par2);
	}

//	protected void rotateCorpse(EntityLiving par1EntityLiving, float par2, float par3, float par4)
//	{
//		this.rotatePlayer((EntityHNPCs)par1EntityLiving, par2, par3, par4);
//	}
...
//	{
//		this.renderPlayerSleep((EntityHNPCs)par1EntityLiving, par2, par4, par6);
//	}
//
//	protected void func_98190_a(EntityLiving par1EntityLiving)
//	{
//		this.func_98191_a((EntityHNPCs)par1EntityLiving);
//	}

	public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
	{
		this.renderHNPC((EntityHNPCs) par1EntityLiving, par2, par4, par6, par8, par9);
	}
	...
	{
		this.renderHNPC((EntityHNPCs) par1Entity, par2, par4, par6, par8, par9);
	}
}

...
@Mod(modid="CompactEngine", name="CompactEngine", version="build 5(for mc1.5.2  bc3.7.1  Forge#737 )", dependencies ="required-after:BuildCraft|Energy")
...
public class CompactEngine
{
	...
	public static final String TEX = "/mods/CompactEngine/textures/blocks/";
	...
	public void load(FMLInitializationEvent event)
	{
		...
		((Block)engineBlock).setUnlocalizedName("CompactEngine:CompactEngineWood");
		engineItem  = new ItemCompactEngine(blockID_CompactEngine - 256);

		Block.blocksList[BuildCraftEnergy.oilMoving.blockID] = null;
		oilMoving = (new BlockOilFlowing2(BuildCraftEnergy.oilMoving.blockID, Material.water)).setUnlocalizedName("oil");
...
//		LanguageRegistry.instance().addStringLocalization("tile.CompactEngineWood.level_5.name", "ja_JP", "2048倍圧縮 木エンジン");
		...
		{
			energyChecker = new ItemEnergyChecker(itemID_energyChecker - 256).setUnlocalizedName("CompactEngine:energyChecker");
